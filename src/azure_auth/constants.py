...
# Microsoft Graph PowerShell ("Microsoft Graph Command Line Tools"). Works by dynamic consent:
# the scopes a token carries are the ones already consented to in the tenant.
